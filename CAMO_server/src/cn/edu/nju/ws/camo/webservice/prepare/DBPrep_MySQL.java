...
public class DBPrep_MySQL 
{
	...
	public void loadFuseSchema() 
	{
		...
		String sqlTabStr2 = "CREATE TABLE preference (uid int NOT NULL, inst text , media_type varchar(255) DEFAULT NULL, inst_type text, u_action int(11) DEFAULT NULL, subscribe bit(1) DEFAULT NULL, u_time datetime DEFAULT NULL, KEY uid_idx (uid))"
						  + " ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin";
		Connection conn = null;
		try {
